### SSS_Data_Package_v2_function_RenameSummarySiteID.R ##############################

## File Metadata
# Author: Bibi Powers-McCormack
# Contact Info: bibi.powers-mccormack@pnnl.gov
# Date Created: 2023-07-26 by Bibi Powers-McCormack
...
rename_summary_site_id <- function(filepath, old_SiteID, new_SiteID) {
  # gather correct file path to read in
  filename <- list.files(filepath, pattern = "Summary")
