...
# USER INPUTS
your_essdive_metadata_file <- "Z:/00_ESSDIVE/03_Manuscript_DPs/Regier_2024_WRB_YRB_Scaling_Manuscript_Data_Package/ESSDIVE_Metadata.docx" # absolute file path of ESS-DIVE metadata .docx
...
your_essdive_id = "" # id that begins with "ess-dive-" found on the landing page you want to update
