...
> <p style='color: `r ifelse(x_recommended_failed > 0, "darkred", "green")`;'><strong>**Your data package passed `r y_recommended_total - x_recommended_failed` of `r y_recommended_total` strongly_recommended test(s).** </strong></p>
