...
This table summarizes column-level details across all the tabular files in your data package. While it does not enforce strict pass/fail criteria like the data checks, it summarizes dataset structure and flags potential issues for further review, enabling users to assess data quality within the context of their data package.  
...
data_package_checks$tabular_report %>% 
  select(file_name, column_name, column_type, num_rows, num_unique_rows, num_missing_rows, num_negative_rows, range_min, range_max, top_counts) %>%   
  # reorder
  ...
  # add column lines
  formatStyle(columns = c("file_name", "column_name", "column_type", "num_rows", "num_unique_rows", "num_missing_values",
