...
The data quality checks help data packages comply with the best practices for accessibility and usability. The data checks are not intended to interpret the meaning of the data, assess scientific validity, fix issues that were detected, or replace human judgement. Authors, domain experts, and the data management team must still review the data and make context-specific decisions, including confirming the correct land and funding acknowledgements, before publishing.  
