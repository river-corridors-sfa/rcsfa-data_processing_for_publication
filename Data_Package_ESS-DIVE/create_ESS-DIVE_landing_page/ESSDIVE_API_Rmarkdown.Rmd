...
fun_file_main = paste(script_path_main,'funs.R',sep='')
```
...
if(all(checkid)){
  ...
  post =uploading_script(script_path_main,json_file_main,Author_Info_main,package_path_main,docx_file_main,API_website_main,author_file_main,zip_file_main,spatial_csv_main,spatial_header_main,spatial_coor_lat_main,spatial_coor_long_main)
  print(post)
