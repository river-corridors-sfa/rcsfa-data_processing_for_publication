...
my_directory = "Z:/00_ESSDIVE/01_Study_DPs/WHONDRS_YDE21_Data_Package_v3/WHONDRS_YDE21_Data_Package_v3"
...
my_dp_keyword = "v3_WHONDRS_YDE21"

# out_dir = string of the absolute folder you want the flmd and dd saved to; do not include "/" at end.
my_out_dir = 'Z:/00_ESSDIVE/01_Study_DPs/WHONDRS_YDE21_Data_Package_v3/WHONDRS_YDE21_Data_Package_v3'
