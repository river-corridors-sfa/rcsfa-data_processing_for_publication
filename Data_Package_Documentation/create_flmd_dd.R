...
my_directory = 'Z:/00_ESSDIVE/03_Manuscript_DPs/Bao_2026_Drone_Methods/Bao_2026_Drone_Methods'
...
my_dp_keyword = "Bao_2026_Drone_Methods"

# out_dir = string of the absolute folder you want the flmd and dd saved to; do not include "/" at end.
my_out_dir = 'Z:/00_ESSDIVE/03_Manuscript_DPs/Bao_2026_Drone_Methods'
