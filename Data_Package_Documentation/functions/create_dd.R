...
create_dd <- function(files_df, 
  ...
  if (add_boye_headers == T) {
    ...
    boye_header_rows <- tribble(~Column_or_Row_Name, ~Unit, ~ Definition, ~Data_Type, ~Term_Type, ~Missing_Value_Code, ~associated_files, 
                                "Unit", "N/A",	"Unit of measurement that applies to a given column or row in the data package.",	"text", "row_header", '"N/A"; "-9999"; ""; "NA"', "boye template", 
                                "Unit_Basis", "N/A",	"Basis of the units listed in the column.",	"text", "row_header", '"N/A"; "-9999"; ""; "NA"', "boye template", 
                                "MethodID_Analysis", "N/A",	"Method code defining information about analysis of the samples that led to the data presented in the column.",	"text", "row_header", '"N/A"; "-9999"; ""; "NA"', "boye template", 
                                "MethodID_Inspection", "N/A",	"Method code defining information about inspection of the samples that led to the data presented in the column.",	"text", "row_header", '"N/A"; "-9999"; ""; "NA"', "boye template", 
                                "MethodID_Storage", "N/A",	"Method code defining information about storage of the samples that led to the data presented in the column.",	"text", "row_header", '"N/A"; "-9999"; ""; "NA"', "boye template", 
                                "MethodID_Preservation", "N/A",	"Method code defining information about preservation of the samples that led to the data presented in the column.",	"text", "row_header", '"N/A"; "-9999"; ""; "NA"', "boye template", 
                                "MethodID_Preparation", "N/A",	"Method code defining information about preparation of the samples that led to the data presented in the column.",	"text", "row_header", '"N/A"; "-9999"; ""; "NA"', "boye template", 
                                "MethodID_DataProcessing", "N/A",	"Method code defining information about data processing that led to the data presented in the column.",	"text", "row_header", '"N/A"; "-9999"; ""; "NA"', "boye template", 
                                "Analysis_DetectionLimit", "N/A",	"Analytical detection limit.",	"numeric", "row_header", '"N/A"; "-9999"; ""; "NA"', "boye template", 
                                "Analysis_Precision", "N/A",	"Precision of the data values.",	"numeric", "row_header", '"N/A"; "-9999"; ""; "NA"', "boye template", 
                                "Data_Status", "N/A",	"State of data readiness for publication and use.",	"text", "row_header", '"N/A"; "-9999"; ""; "NA"', "boye template")
  ...
  if (add_flmd_dd_headers == T) {
    ...
    flmd_placeholder_entires <- tribble(~Column_or_Row_Name, ~Unit, ~ Definition, ~Data_Type, ~Term_Type, ~Missing_Value_Code, ~associated_files, 
                                        ...
                                        "File_Path", "N/A", "File path within the data package.", "text", "column_header", '"N/A"; "-9999"; ""; "NA"', "flmd template")
    ...
    dd_placeholder_entires <- tribble(~Column_or_Row_Name, ~Unit, ~ Definition, ~Data_Type, ~Term_Type, ~Missing_Value_Code, ~associated_files, 
                                      "Column_or_Row_Name", "N/A", "Column or row headers from each tabular file (csv or tsv) in the dataset.", "text", "column_header", '"N/A"; "-9999"; ""; "NA"', "dd template", 
                                      "Unit",  "N/A", "Unit of measurement that applies to a given column or row in the data package.", "text", "column_header", '"N/A"; "-9999"; ""; "NA"', "dd template",
                                      "Definition", "N/A", "Description of the information in a given column or row in the dataset.definition", "text", "column_header", '"N/A"; "-9999"; ""; "NA"', "dd template",
                                      "Data_Type", "N/A", "Type of data (numeric; text; date; time; datetime).", "text", "column_header", '"N/A"; "-9999"; ""; "NA"', "dd template", 
                                      "Term_Type", "N/A", "Indicates how the term is used in the data package (e.g., a column_header, row header, data flag, or other variable).", "text", "column_header", '"N/A"; "-9999"; ""; "NA"', "dd template", 
                                      "Missing_Value_Code", "N/A", 'Cells with missing data are represented with a missing value code rather than an empty cell. This column describes which missing value codes were used. In most cases, the missing value code for numeric data is "-9999" and for character data is "N/A". Some files also use a missing value format specific to when a data value is below the limit of detection or above/below the standard curve. For these cases: a text string is included in the format "[data type]_*|*_Raw_Not_Corrected|*_Final_Corrected" in which the asterisks are the denoted individual data values. See the associated methods deviation (DTL_003) description for more details.', "text", "column_header", '"N/A"; "-9999"; ""; "NA"', "dd template")
